...
RUN cd /usr/src \
    # TODO: put back the original andywilcock
    && wget https://src.fedoraproject.org/lookaside/pkgs/cambozola/cambozola-latest.tar.gz/1212f0a67586efad0d60b741938415c1/cambozola-latest.tar.gz \
